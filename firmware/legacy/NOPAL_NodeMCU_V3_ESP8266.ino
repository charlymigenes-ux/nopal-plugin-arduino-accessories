/*
 * ============================================================================
 * NOPAL — Firmware de accesorios para LOLIN NodeMCU V3 / ESP8266
 * ============================================================================
 *
 * Hardware objetivo:
 *   - LOLIN NodeMCU V3
...
// ============================================================================
  ...
  #define NOPAL_DEVICE_NAME "NOPAL NodeMCU V3"
#endif

#ifndef NOPAL_HOSTNAME
  #define NOPAL_HOSTNAME "nopal-nodemcu"
#endif
...
// ============================================================================
// MAPA DE PINES — LOLIN NODEMCU V3
// ============================================================================
//
...
<header>
  <div class="brand">
    <div class="logo">🌵</div>
    <div><h1>NOPAL · NodeMCU V3</h1><div class="sub" id="identity">Cargando estado…</div></div>
  </div>
...
<footer>NOPAL Firmware 2.0 · LOLIN NodeMCU V3 / ESP8266</footer>
</main>
<script>
...
void sendIdentification() {
  ...
  Serial.print(F(",board=lolin_nodemcu_v3"));
...
void printHelp() {
  Serial.println(
    F("NOPAL:HELP,ID?|NET?|STATUS?|R1:ON|R1:OFF|R1:TOGGLE|R1?|WS:r,g,b|WS:PIXEL:n,r,g,b|WS:RANGE:a,b,r,g,b|WS:BRIGHTNESS:n|WS:EFFECT:name|SCENE:name|A0?|REBOOT")
  );
}
...
void setup() {
  ...
  Serial.print(F("NOPAL:BOARD,lolin_nodemcu_v3,chip_id="));
